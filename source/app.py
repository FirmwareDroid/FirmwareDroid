...
from auth.jwt_auth import check_if_token_is_revoked
from model.UserAccount import RegistrationStatus
from config.app_settings import get_application_setting, set_active_storage_folders
from auth.basic_auth import basic_auth
from env_config import ApplicationConfig
...
def clear_cache(app_instance):
    ...
    """
    # TODO create Scheduler for deleting cache files when workers are idle
