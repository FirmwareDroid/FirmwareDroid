...
from firmware_handler.const_regex_patterns import PRODUCT_BRAND_LIST, PRODUCT_MODEL_LIST, \
    PRODUCT_LOCALE_LIST, PRODUCT_MANUFACTURER_LIST, PRODUCT_LOCAL_REGION_LIST
from statistics.statistics_common import create_objectid_list, set_attribute_frequencies, \
