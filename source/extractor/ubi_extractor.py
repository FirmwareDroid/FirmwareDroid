...
def extract_ubi_image(img_file_path, output_path):
    ...
    try:
        ...
        logging.warning(f"UBI-Reader called SystemExit Code: {err}")
    except Exception as err:
        logging.warning(err)
    logging.info("Ubi reader finished")
    return is_extracted


def ubireader_extract_images(args, img_file_path):
    """
    UBI Reader is a Python module and collection of source capable of extracting the contents of UBI and UBIFS images,
