...
def start_androguard_analysis(android_app_id_list):
    ...
    logging.info(f"Androguard analysis started! With {str(len(android_app_list))} apps.")
    if len(android_app_list) > 0:
        start_process_pool(android_app_list, androguard_worker_mulitprocessing, os.cpu_count())
