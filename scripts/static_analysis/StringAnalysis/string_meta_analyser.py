...
from scripts.static_analysis.StringAnalysis.secret_regex import SECRET_REGEX_PATTERNS
from scripts.static_analysis.StringAnalysis.url_detection import detect_domains
from scripts.static_analysis.StringAnalysis.encoding_detection import detect_encoding, decode
...
def meta_analyzer_worker(string_analysis_id_queue):
    ...
    while True:
        string_analysis_id = string_analysis_id_queue.get()
        try:
