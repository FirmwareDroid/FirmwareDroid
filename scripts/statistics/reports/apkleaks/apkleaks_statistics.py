...
def create_apkleaks_statistics_report(android_app_id_list, report_name):
    ...
    if reports_count > 1:
        apkleaks_statistics_report = create_empty_apkleaks_statistics_report(report_name,
                                                                             reports_count,
                                                                             android_app_id_list,
...
def get_apkleaks_statistics_report(android_app_objectid_list, report_objectid_list, apkleaks_statistics_report):
    ...
    apkleaks_statistics_report.leaks_reference_dict = stream_to_json_file(leaks_reference_tempfile.name).id
    apkleaks_statistics_report.save()
    ...
    apkleaks_statistics_report.leaks_count_dict = leaks_count_dict
    apkleaks_statistics_report.save()
